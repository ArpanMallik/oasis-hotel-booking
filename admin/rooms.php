                        ...
                        <table class="table table-hover border">
                            <thead>
                                <tr class="bg-dark text-light sticky-top">
                                    <th class="text-center align-middle" scope="col" width="60%">Image</th>
                                    <th class="text-center align-middle" scope="col">Thumb</th>
