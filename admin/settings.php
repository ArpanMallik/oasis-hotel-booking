    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="card border-0 shadow mb-4">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <button type="button" class="btn btn-primary dark shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#general-s">
                ...
                <!---- General settings model  section---->
                    ...
                    <div class="card border-0 shadow mb-4">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <button type="button" class="btn btn-primary dark shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#contacts-s">
                                    <i class="bi bi-pencil-square"></i> Edit
                                </button>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <!---- Contact settings model  section---->
                    ...
                    <div class="card  shadow ">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <button type="button" class="btn btn-primary dark shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#team-s">
