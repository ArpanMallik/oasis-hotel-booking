...
if (isset($_GET['fetch_rooms'])) {
  ...
  // check availability filter logic validation
  ...
  //fetching Setting table to shut down to check website  is shutdowwn value
  ...
  while ($room_data = mysqli_fetch_assoc($room_res)) {
    ...
    if ($chk_avail['checkin'] != '' && $chk_avail['checkout'] != '') {
      ...
      $values = ['pending', $room_data['id'], $chk_avail['checkin'], $chk_avail['checkout']];
